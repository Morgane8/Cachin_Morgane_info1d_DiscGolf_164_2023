...
class FormWTFAjouterPlastic(FlaskForm):
    """
    ...
    nom_genre_regexp = ""
    name_plastic_type_wtf = StringField("Clavioter le type de plastique ", validators=[Length(min=2, max=20, message="min 2 max 20"),
    ...
    submit = SubmitField("Enregistrer plastic")



class FormWTFUpdatePlastic(FlaskForm):
    """
