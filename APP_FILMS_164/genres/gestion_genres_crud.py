...
"""
    ...
    Paramètres : order_by : ASC : Ascendant, DESC : Descendant
                id_person_sel = 0 >> tous les genres.
                id_person_sel = "n" affiche le genre dont l'id est "n"
"""


@app.route("/genres_afficher/<string:order_by>/<int:id_person_sel>", methods=['GET', 'POST'])
def genres_afficher(order_by, id_person_sel):
    if request.method == "GET":
        try:
            with DBconnection() as mc_afficher:
                ...
                if not data_genres and id_person_sel == 0:
                    flash("""La table "t_person" est vide. !!""", "warning")
                elif not data_genres and id_person_sel > 0:
        ...
        try:
            if form.validate_on_submit():
                ...
                valeurs_insertion_dictionnaire = {"value_last_name_pers": last_name_genre,
                                                  ...
                                                  "value_birthday_pers": birth_date_pers,
                                                  "value_gender_pers": gender_pers,
                                                  "value_nationality_pers": nationality_pers}
                print("valeurs_insertion_dictionnaire ", valeurs_insertion_dictionnaire)

                strsql_insert_person = """INSERT INTO t_person (id_person,last_name_pers,first_name_pers, birth_date_pers, gender_pers, nationality_pers) VALUES (NULL,%(value_last_name_pers)s,%(value_first_name_pers)s,%(value_birthday_pers)s, %(value_gender_pers)s, %(value_nationality_pers)s) """
                ...
                return redirect(url_for('genres_afficher', order_by='DESC', id_person_sel=0))
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_annuler.data:
                return redirect(url_for("genres_afficher", order_by="ASC", id_person_sel=0))
            ...
            if form_delete.submit_btn_del.data:
                valeur_delete_dictionnaire = {"value_id_person": id_genre_delete}
                print("valeur_delete_dictionnaire ", valeur_delete_dictionnaire)

                str_sql_delete_films_genre = """DELETE FROM t_pers_possess_disc WHERE fk_person = %(value_id_person)s"""
        ...
        if request.method == "GET":
            valeur_select_dictionnaire = {"value_id_person": id_genre_delete}
            ...
            str_sql_genres_films_delete = """SELECT id_pers_possess_disc, label_disc, id_person, last_name_pers FROM t_pers_possess_disc
                                            ...
                                            WHERE fk_person = %(value_id_person)s"""
            ...
            form_delete.nom_pers_delete_wtf.data = data_nom_genre["last_name_pers"]
