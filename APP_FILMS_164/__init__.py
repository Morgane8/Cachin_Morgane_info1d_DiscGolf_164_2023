...
try:
    ...
    from APP_FILMS_164.disc import gestion_disc_crud
    from APP_FILMS_164.disc import gestion_disc_wtf_forms

    from APP_FILMS_164.plastic import gestion_plastic_crud
    from APP_FILMS_164.plastic import gestion_plastic_wtf_forms
